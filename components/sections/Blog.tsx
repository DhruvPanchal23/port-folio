...
const PLACEHOLDER_POSTS: BlogPost[] = [
  {
    ...
    category: 'Engineering', tags: ['Performance', 'Next.js', 'Optimization'], status: 'published', featured: false, read_time: 8,
  ...
  },
  {
    ...
    category: 'Design', tags: ['Design Systems', 'Figma', 'React'], status: 'published', featured: false, read_time: 12,
  ...
  },
  {
    ...
    category: 'Security', tags: ['Security', 'API', 'Backend'], status: 'published', featured: false, read_time: 15,
