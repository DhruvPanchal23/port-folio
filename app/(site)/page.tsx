...
const SERVICES = [
  {
    ...
    desc: 'End-to-end web apps — from data model to deploy. Clean code, typed everywhere, tested before it ships.',
  },
  {
    icon: Sparkles,
    title: 'Product design + UI',
    desc: 'Pixel-precise interfaces with a soul. Design tokens, motion, accessibility baked in from day one.',
  },
  {
    icon: Zap,
    title: 'Performance & DX',
    desc: 'Tuning Core Web Vitals, refactoring spaghetti, setting up CI so your team ships faster, not slower.',
  },
  {
    icon: Cpu,
    title: 'AI / automation glue',
    desc: 'LLM workflows, agents, internal tools — pragmatic AI that saves hours, not a chatbot toy.',
  },
];
        ...
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-12 mb-16">
            ...
            <p className="text-muted-foreground md:text-lg max-w-2xl self-end leading-relaxed">
              I keep my surface area small on purpose. These are the things I genuinely care about
              and will obsess over until they&apos;re right. Anything outside of this, I&apos;ll
              happily point you to someone better.
            </p>
          </div>
